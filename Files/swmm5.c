...
//   - Declare global variable for input file name for to use in output.c for text file export
//     
//-----------------------------------------------------------------------------
...
char InputFileName[512];          // Declare global variable for input file name            //(ue-avg)
...
//
{
    ...
    // --- Store the input file name globally so output.c can use it            //(ue-avg)
    strncpy(InputFileName, f1, sizeof(InputFileName) - 1);                      //
